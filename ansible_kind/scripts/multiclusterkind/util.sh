...
function util::setup_macvlan {
    ...
    docker exec "${context_name}"-control-plane chmod 755 /opt/cni/bin/macvlan
    docker exec "${context_name}"-control-plane chmod 755 /opt/cni/bin/static
    docker exec "${context_name}"-control-plane chmod 755 /opt/cni/bin/tuning
}
